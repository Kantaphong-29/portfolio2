        ...
        <>
            <main className='flex-grow'>
                <div className='container mx-auto py-10 px-4'>
                    <button onClick={() => navigate(-1)} className='bg-gray-500 text-white font-semibold rounded-full hover:bg-gray-700 transition cursor-pointer px-3 py-2'>Back</button>
                    <div className='mt-8 bg-white rounded-lg shadow-lg overflow-hidden flex flex-col md:flex-row'>
                        ...
                        <div className='md:w-1/2 w-full p-6 flex flex-col'>
                            <h1 className='text-3xl font-bold mb-4 text-gray-800'>{cardDetail.title}</h1>
